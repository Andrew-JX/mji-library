...
<template>
  <div class="container mt-5">
    <div class="row">
      <!-- Make it full-width on xs, narrow and centered from sm/md up -->
      <div class="col-12 col-sm-10 col-md-8 col-lg-6 offset-0 offset-sm-1 offset-md-2 offset-lg-3">
        <h1 class="text-center mb-3 display-6 display-md-5">User Information Form</h1>

        <form @submit.prevent="submitForm">
          <!-- Use a responsive form grid: single column on xs, two columns from md up -->
          <div class="row g-3">
